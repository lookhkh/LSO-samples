...
class KafkaProducerUnFinishedMain {
    public static void main(String[] args) {
        ...
        IntStream.range(0, 10).mapToObj(t->new ProducerRecord<String,String>("test",t+" from unFinishedProducer")).forEach(t-> producer.send(t));
        producer.flush();
